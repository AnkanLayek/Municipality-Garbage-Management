...
const AssignCardComponent = ({pathName, pathId, dustbinNo, driverName, vehicleNo, children}) => {
    ...
    return(
        <>
            <div className="relative w-[27rem] py-10 flex flex-col items-center justify-center gap-8" style={{boxShadow: "10px 10px 20px 4px rgb(0 0 0 / 0.1), -10px -10px 20px 4px rgb(0 0 0 / 0.1)", background: "linear-gradient(45deg, #e6f5e6, #b9ebb9)"}}>
